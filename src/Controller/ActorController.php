...
class ActorController extends AbstractController
{
     ...
     */
    public function show($slug, Actor $actor): Response
    {
     ...
     */
    public function edit($slug, Request $request, Actor $actor, Slugify $slugify): Response
    {
        $form = $this->createForm(ActorType::class, $actor);
        $form->handleRequest($request);
     ...
     */
    public function delete($slug, Request $request, Actor $actor): Response
    {
